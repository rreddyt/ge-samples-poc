...
| 🖼️ [**`sku-genmedia/`**](sku-genmedia/README.md) | ADK Python, Gemini 3.5, Veo 3.1, BigQuery, GCS, Dotenv | **Multi-Agent Product Lifestyle Content (Image & Video) Generator:** A premium ADK multi-agent routing architecture consisting of a parent director delegating to specialized image (Gemini 3.1 Flash Image) and video (Veo 3.1 Fast Generate) sub-agents to automatically generate and upload stunning product marketing content to GCS. |
